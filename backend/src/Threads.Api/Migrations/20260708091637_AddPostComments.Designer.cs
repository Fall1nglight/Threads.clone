...
namespace Threads.Api.Migrations
{
    ...
    [Migration("20260708091637_AddPostComments")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Threads.Api.Data.Follows.Follow", b =>
                {
            ...
            modelBuilder.Entity("Threads.Api.Data.Likes.PostLike", b =>
                {
                    b.Property<Guid>("PostId")
                        .HasColumnType("uuid");
                    ...
                    b.HasIndex("PostId", "CreatedAtUtc", "UserId");

                    b.ToTable("PostLikes", "social");
                });

            modelBuilder.Entity("Threads.Api.Data.Posts.Post", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityUserClaim<System.Guid>", b =>
                {
                    b.HasOne("Threads.Api.Data.Users.User", null)
                        .WithMany()
            ...
            modelBuilder.Entity("Threads.Api.Data.Comments.Comment", b =>
                {
                    b.HasOne("Threads.Api.Data.Posts.Post", "Post")
                        .WithMany()
            ...
            modelBuilder.Entity("Threads.Api.Data.Follows.Follow", b =>
                {
                    b.HasOne("Threads.Api.Data.Users.User", "Followed")
                        .WithMany()
                        .HasForeignKey("FollowedId")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();

                    b.HasOne("Threads.Api.Data.Users.User", "Follower")
                        .WithMany()
